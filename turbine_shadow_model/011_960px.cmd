...
CALL wandb disabled
CALL python %yolo_path%/train.py --epochs 500 --img-size 960 --batch 2 --workers 4 --cfg %yolo_path%/cfg/training/yolov7.yaml --hyp %hyp_path% --data data/turbine_shadow_data/%data%/data.yaml --weights %weights_path% --device 0 --name %experiment%
